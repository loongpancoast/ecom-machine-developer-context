...
## Current commissioned scope — 2026-09-22

The [public owner-requirements summary](../owner-requirements-summary.json) is the current authority ahead of historical excerpts and ignored interviews. The full original ecommerce vision is included in the commissioned, completed system—not a reduced core, future out-of-contract ambition, demo, scaffold or disconnected automation. The limitations under each source below identify gaps in this reference pack, **not exclusions from delivery**.

- **Live testing:** **60 live product tests per month** is both an operational and final-acceptance requirement. Each test includes completed research, economics and offer; finished original ads; a functioning purchase destination; a live budgeted campaign; verified tracking; and recorded spend, results and decisions. Sixty rows, creative variants, dry runs or simulations are not sixty live product tests. This requirement does not guarantee product profitability.
- **Complete commerce:** Build full Shopify stores and catalogs, not standalone landing-page mockups. Include bulk creation/update, import and migration, products/variants, collections, media, metafields and templates, stable identities, item-level errors and duplicate-safe retries. Include domains, native Liquid themes, responsive navigation and pages, policies, working checkout/payment/shipping, offers, bundles, upsells/cross-sells, post-purchase flows and tested SEO/AEO/GEO surfaces. IN03 establishes identity lessons only; IN11 adds historical touchpoints, not the finished implementation.
- **Meta infrastructure and measurement:** Connect Facebook Pages, business/ad accounts, catalogs and applicable Instagram links; implement and verify Pixel and CAPI purchase tracking, consent behavior, event/value/product fields and browser/server deduplication against test orders. Join actual ad delivery and spend to the exact creative, offer, destination, product and commerce results. IN06’s paused-draft and untested-write statements are historical source status, not acceptable final delivery.
- **Connected sourcing and operations:** Include supplier discovery, quotes, diligence, negotiation, QC, purchase orders and routing, 3PL fulfillment, tracking, returns, customer support, retention, accounting and profitability. IN07–IN11 and [C12](../context/C12-evolve-supplier-selection-negotiation-and-diligence.md)/[C17](../context/C17-original-sourcing-payload-and-downstream-catalog-semantics.md) provide methods, not completed adapters. Connect communications, orders, stock/exceptions, returns/refunds, permitted messages and financial records with target-bound readbacks, error handling and duplicate protection. This is not a requirement to own a warehouse, replace a payment rail or build a separate standalone ERP. Owner, legal/KYC and platform-approval dependencies must be supported and scheduled; they do not exclude functionality.
- **Engine and media access:** Codex **and** Claude power development and the deployed agent-led engine through supported official access with terms and capacity verified. Do not assume subscriptions include API usage. Prefer direct **image and video APIs**; an aggregator is justified only when its skill or full workflow improves the rendered result through an owner-controlled adapter. The former video-only API limit is superseded.
- **Owned capability and output quality:** Amboras, Arcads, Higgsfield, Atria and Brandsearch are capability/quality references to create inside the owned engine, not a bundle of SaaS links or literal replication of every vendor feature. Preserve broader research-source coverage and attribution. Produce reference-led original ads/pages without unauthorized footage, fake testimonials or unsubstantiated claims. Inspect actual decoded media and rendered/functional storefront output against references, then iterate from measured evidence; provider status fields are not creative acceptance.
- **Upgrades and commercial terms:** Preserve owner-controlled source context, data, assets and history when replacing models, providers, skills and whole workflows or combining/removing stages. Demonstrate version/restore and compare quality, cost, speed and reliability, so improving AI capabilities can be adopted without a literal AGI guarantee. Engineering is negotiable within **$6,000-$8,000**, with $8,000 a ceiling rather than a committed fee; agree price, milestones and schedule before hiring, targeting roughly one month. Operating ad/media/platform spend is separately approved. No expenditure, account action or external execution is authorized by this reference index.

Historical approval-heavy prompts, disabled roles, fixed platform choices and report-only outputs remain preserved source evidence. Their useful input/output contracts inform the build; current acceptance requires the connected functions and live outcomes above. Keep applicant/account records, private paths and paid course text out of this public handoff.
